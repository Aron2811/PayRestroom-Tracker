...
class OwnerTagInformation extends StatefulWidget {
  final MarkerId markerId;
  final LatLng destination;

  const OwnerTagInformation({
    Key? key,
  ...
  @override
  _OwnerTagInformationnState createState() => _OwnerTagInformationnState();
}

class _OwnerTagInformationnState extends State<OwnerTagInformation> {
                      ...
                      onPressed: () {
                        ...
                        showDialog(
                            ...
                            builder: (context) => AlertDialog(
                                  title: const Text(
                                    "Are you sure you want to suggest to delete this paid restroom?",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        color:
